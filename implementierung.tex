...
Für die Implementierung der Alpaka"=\textit{Events} stellt dies ein nicht zu
...
\subsubsection{Vom SYCL- zum Alpaka-\textit{Kernel}}
...
\subsection{Kopier"= und \texttt{memset}"=\textit{Tasks}}
