...
Alpaka"=Äquivalente \textit{Block} und \textit{Thread} aus dem
Work"=Division"=Konzept abbilden, weshalb \texttt{parallel\_for} eine gute Wahl
für den SYCL"=Kernel"=Start darstellt.
