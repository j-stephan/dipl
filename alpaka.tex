...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \draw [rounded corners, fill = HKS65!70] (2.75, 0) rectangle (3.825, 8.4)
              node [pos = 0.5, align = center, rotate = 90] {\color{white}\textbf{Alpaka}};
        \draw [rounded corners, fill = HKS65!70] (3.925, 0) rectangle (5.25, 8.4)
        ...
        \draw [rounded corners, fill = HKS65!70] (2.75, 9.75) rectangle (3.825, 21.05)
              node [pos = 0.5, align = center, rotate = 90] {\color{white}\textbf{Alpaka}};
        \draw [rounded corners, fill = HKS65!70] (3.925, 9.75) rectangle (5.25, 21.05)
              node [pos = 0.5, align = center, rotate = 90] {\color{white}\textbf{Nutzer}};
