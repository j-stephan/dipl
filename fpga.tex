...
% unsauber, LUT = look-up table, Boolesche Eingabe-Ausgabe-Abbildungsmatrix (oder Wahrheitstabelle)
...
Hardware durch Flip-flops realisiert werden.
% Def Flip-flop?
Jeder Kasten kann dabei als ein
