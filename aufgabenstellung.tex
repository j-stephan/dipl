...
\taskform{
    ...
    \item Einarbeitung in die FPGA-Programmierung mittels des triSYCL-Compilers
          und des Xilinx-SDAccel-Ökosystems.
    \item Untersuchung der Performance-Analysemöglichkeiten hinsichtlich der
          ...
          und Architekturen.
    \item Evaluierung des SYCL-Backend-Prototypen anhand eines in Alpaka
          entwickelten Verarbeitungsalgorithmus für
          Röntgenstrahlen-Pixeldetektordaten, u.a. hinsichtlich der erreichbaren
          Datenraten auf sowie der Nutzbarkeit von FPGAs.
